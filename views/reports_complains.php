                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Complains</h3>
                                            <div class="nk-block-des text-soft">
                                                <p>
                                                    This module allows you to export complains reports <br>
                                                </p>
                                            </div>
                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li>
                                                            <a href="#export" data-toggle="modal" class="btn btn-white btn-outline-light">
                                    ...
                                    <div class="modal-dialog  modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Filter Complains Per Department & File Type</h4>
                                                ...
                                                <form method="post" action="reports" enctype="multipart/form-data">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select required name="file_type" class="form-control">
                                                    ...
                                                    <div class="text-right">
                                                        <button name="Export_Complains" class="btn btn-primary" type="submit">
