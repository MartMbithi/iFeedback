                                    ...
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>
                                                    This module allows you to manage departments <br>
                                                </p>
                                            </div>
                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select required name="department_directorate_id" class="form-control">
                                                                ...
                                                                ?>
                                                                        <option value="<?php echo $rows['directorate_id']; ?>"><?php echo $rows['directorate_name']; ?></option>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="email" name="department_email" required class="form-control">
                                                        </div>
                                                    </div>
                                                    <br><br>
                                                    <div class="text-right">
                                                        <button name="Add_Department" class="btn btn-primary" type="submit">
                                                ...
                                                <table class="datatable-init table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    <td><?php echo $cnt; ?></td>
                                                                    <td><?php echo $rows['directorate_name']; ?></td>
                                                                    <td><?php echo $rows['department_name']; ?></td>
                                                                    <td><?php echo $rows['department_email']; ?></td>
                                                                    <td>
                                                                        <a data-toggle="modal" href="#update_<?php echo $rows['department_id']; ?>" class="badge badge-dim badge-pill badge-outline-secondary"><em class="icon ni ni-edit"></em> Edit</a>
                                                                        <a data-toggle="modal" href="#delete_<?php echo $rows['department_id']; ?>" class="badge badge-dim badge-pill badge-outline-danger"><em class="icon ni ni-trash"></em> Delete</a>
                                                                    </td>
                                                                </tr>
                                                        <?php
                                                                $cnt = $cnt + 1;
