                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="text" name="directorate_name" required class="form-control">
                                                        </div>
                                                    </div>
                                                    <br><br>
                                                    <div class="text-right">
                                                        <button name="Add_Directorate" class="btn btn-primary" type="submit">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a data-toggle="modal" href="#update_<?php echo $rows['directorate_id']; ?>" class="badge badge-dim badge-pill badge-outline-secondary"><em class="icon ni ni-edit"></em> Edit</a>
                                                                        <a data-toggle="modal" href="#delete_<?php echo $rows['directorate_id']; ?>" class="badge badge-dim badge-pill badge-outline-danger"><em class="icon ni ni-trash"></em> Delete</a>
                                                                    </td>
                                                                </tr>
                                                        <?php
                                                                $cnt = $cnt + 1;
                                                                include('../modals/directorates.php');
                                                            }
                                                        } ?>
                                                    </tbody>
                                                </table>
