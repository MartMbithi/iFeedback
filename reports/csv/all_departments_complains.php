...
/* Excel File Name */
$fileName = "All Complains In All Departments.xls";
...
$query = $mysqli->query("SELECT * FROM feedbacks WHERE feedback_type = 'Complain' AND  feedback_iscomplete = '1' ORDER BY feedback_id DESC");
$cnt = 1;
if ($query->num_rows > 0) {
