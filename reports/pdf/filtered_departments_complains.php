                ...
                <body style="margin:1px;">
                    ...
                    <div class="list_header" align="center">
                        <h3>
                            ...
                            '.$department.' Department Complains
                        </h3>                        
                    </div>
                    <table border="1" cellspacing="0" width="100%" style="font-size:9pt">
                        <thead>
                            <tr>
                                ...
                                <th style="width:100%">Complain</th>
                                <th style="width:40%">Date</th>
                                <th style="width:40%">Status</th>
                                <th style="width:70%">Complain By</th>
                            </tr>
                        </thead>
                        <tbody>
                            ';
                                $pdf_sql = mysqli_query(
                                    $mysqli,
                                    "SELECT * FROM feedbacks WHERE feedback_type = 'Complain' AND  feedback_iscomplete = '1' ORDER BY feedback_id DESC"
                                );
                                $cnt = 1;
...
$dompdf->render();
$dompdf->stream($department. ' Complain Records', array("Attachment" => 1));
